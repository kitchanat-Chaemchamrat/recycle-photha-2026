...
if (isset($_GET['ajax']) && $_GET['ajax'] === 'details') {
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-4"><strong>เจ้าของ:</strong> <?php echo htmlspecialchars($ev['owner_name']); ?></div>
        <div class="col-md-4"><strong>ผู้ตรวจ:</strong> <?php echo htmlspecialchars($ev['evaluator_name']); ?></div>
        <div class="col-md-4"><strong>สถานะ:</strong> <?php echo htmlspecialchars($ev['approval_status']); ?></div>
        <div class="col-md-4"><strong>คะแนนรวม:</strong> <?php echo (int)$ev['total_score']; ?></div>
        <div class="col-md-4"><strong>อนุมัติโดย:</strong> <?php echo htmlspecialchars($ev['approver_name'] ?? '-'); ?></div>
        <div class="col-md-4"><strong>ไม่อนุมัติโดย:</strong> <?php echo htmlspecialchars($ev['rejector_name'] ?? '-'); ?></div>
    </div>
    <div class="row g-2 mb-3">
        <div class="col-6 col-md-3"><div class="p-2 border rounded"><small>เศษอาหาร</small><div class="fw-bold"><?php echo (int)$ev['food_score']; ?></div></div></div>
        <div class="col-6 col-md-3"><div class="p-2 border rounded"><small>พลาสติก</small><div class="fw-bold"><?php echo (int)$ev['plastic_score']; ?></div></div></div>
        <div class="col-6 col-md-3"><div class="p-2 border rounded"><small>กระดาษ</small><div class="fw-bold"><?php echo (int)$ev['paper_score']; ?></div></div></div>
        <div class="col-6 col-md-3"><div class="p-2 border rounded"><small>แก้ว</small><div class="fw-bold"><?php echo (int)$ev['glass_score']; ?></div></div></div>
        <div class="col-6 col-md-3"><div class="p-2 border rounded"><small>โลหะ</small><div class="fw-bold"><?php echo (int)$ev['metal_score']; ?></div></div></div>
        <div class="col-6 col-md-3"><div class="p-2 border rounded"><small>ปนเปื้อน</small><div class="fw-bold"><?php echo $ev['contamination'] ? 'พบ' : 'ไม่พบ'; ?></div></div></div>
    </div>
    <div class="mb-3">
...
<form class="card mb-4 no-print" method="GET">
    <div class="card-body">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                <label class="form-label">บ้าน/เจ้าของ/ซอย</label>
    ...
    <?php foreach ($evaluations as $ev): ?>
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-3 mb-3">
                        <div class="col-md-3"><strong>บ้าน:</strong> <?php echo htmlspecialchars($ev['house_no']); ?></div>
                        <div class="col-md-3"><strong>เจ้าของ:</strong> <?php echo htmlspecialchars($ev['owner_name']); ?></div>
                        <div class="col-md-3"><strong>ซอย:</strong> <?php echo htmlspecialchars($ev['soi_name']); ?></div>
                        <div class="col-md-3"><strong>ผู้ตรวจ:</strong> <?php echo htmlspecialchars($ev['evaluator_name']); ?></div>
                    </div>
                    ...
                    <?php else: ?>
                        <div class="alert alert-light mb-0">
                            <?php if ($ev['approval_status'] === 'approved'): ?>
                                อนุมัติแล้วโดย <?php echo htmlspecialchars($ev['approver_name'] ?? '-'); ?> เมื่อ <?php echo htmlspecialchars($ev['approved_at'] ?? '-'); ?>
                            <?php else: ?>
                                ไม่อนุมัติโดย <?php echo htmlspecialchars($ev['rejector_name'] ?? '-'); ?> เมื่อ <?php echo htmlspecialchars($ev['rejected_at'] ?? '-'); ?>
                                <?php if (!empty($ev['approval_note'])): ?>
                                    <div class="small text-muted mt-1">หมายเหตุ: <?php echo htmlspecialchars($ev['approval_note']); ?></div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
